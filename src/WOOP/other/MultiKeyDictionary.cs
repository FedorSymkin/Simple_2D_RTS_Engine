...
namespace WOOP
{
    ...
    public class MultiKeyDictionary<PK, SK, V>
    {
        public Dictionary<Pair<PK, SK>, V> dict = new Dictionary<Pair<PK, SK>, V>();

        public void add(PK primaryKey, SK secondaryKey, V value)
        {
            dict.Add(new Pair<PK, SK>(primaryKey, secondaryKey), value);
        }

        public bool TryGetValue(PK primaryKey, SK secondaryKey, out V value)
        {
            return dict.TryGetValue(new Pair<PK, SK>(primaryKey, secondaryKey), out value);
        }
    }
}
